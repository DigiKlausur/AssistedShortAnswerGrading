...
file_path = "/home/mohandass/Documents/RnD/Interactive-short-answer-grading/dataset/nn-dataset/"
...
short_df = df[['student_answer','student_modified', 'pre_grade','question','question_id']]

##binary
# short_df['pre_grade'] = short_df['pre_grade'] >= 3
# short_df['pre_grade'] = short_df['pre_grade'].astype(int)
...
def get_question():
	...
	if counter < threshold:
		...
		print("Actual grade: ",short_df.loc[int(display_idx),'pre_grade'])
...
def label_grade():
	...
	if counter > threshold:
		...
		short_df["manual_grade"][display_idx-1] = human_label
		...
		# short_df["manual_grade"][int(act_data["key_id"][query_idx].values)] = human_label
		# print(human_label)
		# print(query_idx)
...
def save_grade():
	...
	if qn_idx == len(qn_ids):
		...
		## writing the auto grade, manual grade and comment into an ipnb
